...
```{r Figure1.motifRadialPhylog2, fig.cap=fn("signatures with circular dendograms"), fig.width=5, fig.height=5, echo=FALSE}
...
```{r single.motif, fig.width=6, fig.height=3, dpi=72, fig.cap=fn("single DNA motif"), echo=FALSE}
plot(pfms[["Dm_abd_A"]])
```

```{r motif.Stack, fig.width=10, fig.height=5, dpi=72, fig.cap=fn("stack layout"), echo=FALSE}
...
```{r protein.Stack, fig.width=10, fig.height=5, fig.cap=fn("protein motifs"), echo=FALSE}
...
```{r single.protein, fig.width=6, fig.height=3, fig.cap=fn("single protein motif"), echo=FALSE}
plot(pfms[[1]])
```
