...
description <- c("## Dimeric motifs separated from monomeric motifs from the same TF\n\nFor most dimeric clusters, one or more monomeric motifs cluster with a Drosophilar motif, suggesting that the absence of a fly TF in a dimeric cluster may be a methological difference rather than a biological one.", "", "", "", "", "", "\\FloatBarrier\n\n#### There is no monomeric motif in mammals.", "\\FloatBarrier\n\n#### The dimeric motif cluster is different from the above clusters. There are overlaps for the subunits of monomeric motif.", "\\clearpage\n\n#### For MEOX/LHX cluster, there are some exceptions like LHX6_M7193 and Lhx_M7636. The subunit of both has stong G after TAATT comparing to other monomeric motifs with stong A after TAATT.", "\\FloatBarrier\n\n### Difference by platform.\n\nThe absence of a fly TF in a dimeric cluster may be a methological difference rather than a biological one.", "", "", "\\FloatBarrier\n\n## Unique clusters", "\\clearpage\n\n## Cleaned unique clusters")
...
sta <- mapply(function(.ele, name, ID, des){
    kexpand(.ele, id=ID, cap=paste0("Supplementary Figure 7.", name),
