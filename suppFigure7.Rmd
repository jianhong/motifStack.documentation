...
sta <- mapply(function(.ele, name, ID, des){
    kexpand(.ele, id=ID, cap="__Supplementary Figure 7a__: Species-specific motifs for fly or human/mouse. Species-specific motifs in the HD family are shown in purple (Human/SELEX data), brown (Mouse/PBM data) and green (Fly/B1H data)", figheight=ceiling(.25*length(.ele$leaves)), des)
