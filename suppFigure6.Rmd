...
sta <- mapply(function(.ele, name, ID, des){
    ...
    kexpand(.ele, id="", cap="__Supplemental Figure 6__. Motifs of HOX and caudal related TFs are shown in purple (human), brown and orange (mouse) and turquoise (fly). These TFs cluster into two different motif groups, one with fly motifs and the other without fly motifs",
