...
```{r Fly_B1H, fig.width=8, fig.height=11, dpi=72, fig.cap=fn("by matAlign", "A")}
gpDis <- 2
...
```{r Fly_B1H.MotIV, fig.width=8, fig.height=11, dpi=72, fig.cap=fn("by MotIV", "B")}
gpDis <- 0.005 
...
```{r FlyMousePBMSAW, fig.width=12, fig.height=12, dpi=72, fig.cap=fn("Fly vs Mouse", "C")}
gpDis <- 2
...
```{r FlyHuman, fig.width=12, fig.height=12, dpi=72, fig.cap=fn("Fly vs Human", "D")}
gpDis <- 2
...
```{r MmPBM_SELEX, fig.width=12, fig.height=12, dpi=72, fig.cap=fn("Mouse data from different methods", "E.a")}
gpDis <- 2
...
```{r MmPBM_SELEX.ALL, fig.width=12, fig.height=12, dpi=72, fig.cap=fn("Mouse data from different methods", "E.b")}
...
```{r MmPBM_SELE.MotIV, fig.width=12, fig.height=12, dpi=72, fig.cap=fn("by MotIV", "F.a")}
gpDis <- 0.005 
...
```{r MmPBM_SELEX.MotIV.ALL, fig.width=12, fig.height=12, dpi=72, fig.cap=fn("Mouse data from different methods", "F.b")}
motifCircos(phylog=phylog, pfms=motifs, col.tree.bg=methods, 
            col.tree.bg.alpha=.3, r.rings=c(.1, .1), 
            col.rings=list(icgp, rep("white", length(icgp))), 
            col.inner.label.circle=gpCol, inner.label.circle.width=0.02, 
...
```{r EN, fig.width=8, fig.height=4, dpi=72, fig.cap=fn("En", "G")}
gpDis <- 2
...
```{r EN.MotIV, fig.width=8, fig.height=4, dpi=72, fig.cap=fn("En.MotIV", "H")}
gpDis <- 0.005 
...
```{r FlyMousePBMHuman, fig.width=12, fig.height=12, dpi=72, fig.cap=fn("Fly vs Mouse vs Human", "I")}
gpDis <- 2.5
...
```{r FlyMousePBMHuman.MotIV, fig.width=12, fig.height=12, dpi=72, fig.cap=fn("Fly vs Mouse vs Human by MotIV", "J")}
gpDis <- 0.005
