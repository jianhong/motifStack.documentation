...
fn = local({
  ...
  function(x, cnt=TRUE) {
    if(cnt) i <<- i + 1
    paste('Figure 3', LETTERS[i], ': ', x, sep = '')
  }
})
```
...
# Supplemental Figure 3A. alignment of *Drosophila* motifs by matAlign
...
# Supplemental Figure 3B. alignment of *Drosophila* motifs by MotIV
...
# Supplemental Figure 3C. fly vs mouse, by matAlign
```{r FlyMousePBMSAW, fig.width=12, fig.height=12, dpi=72, fig.cap=fn("Fly vs Mouse")}
gpDis <- 2
FlyMousePBMSAW <- getMatAlignOut("pcmsDatasetFlyMousePBM.SAW", groupDistance=gpDis, trim=0.2)
...
# Supplemental Figure 3D. fly vs human, by matAlign
...
# Supplemental Figure 3E. mouse selex vs mouse pbm/sw vs mouse pbm dream5
...
# Supplemental Figure 3F. mouse selex vs mouse pbm/sw vs mouse pbm dream5, by motIV
...
# Supplemental Figure 3G. Engrailed orthologs, by matAlign
...
# Supplemental Figure 3H. Engrailed orthologs, by motIV 
...
# Supplemental Figure 3I. fly vs ms vs hum matAlign
...
# Supplemental Figure 3J. fly vs ms vs hum motIV
