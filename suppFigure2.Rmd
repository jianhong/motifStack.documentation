...
## Supplementary Figure 2Q. Import PFMs/PCMs files from Transfac, CisBP, or JASPAR format in batch mode.

```{r importMatrix, fig.width=12, fig.height=12, dpi=72, fig.cap=fn("Import PFMs/PCMs files from Transfac, CisBP, or JASPAR format", "Q"), message=FALSE, warning=FALSE, error=FALSE}
...
## Supplementary Figure 2H. Plotting affinity logo.

```{r plotAffinityLogo, fig.width=12, fig.height=4, dpi=72, fig.cap=fn("affinity logos for a position specifice affinity matrix (PSAM)", "H"), message=FALSE, warning=FALSE, error=FALSE}
