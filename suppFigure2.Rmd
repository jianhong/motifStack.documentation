...
```{r fig.cap=fn("Merge motifs by different distance", "E"), fig.width=0.1, fig.height=0.02, echo=FALSE}
par(mar=rep(0, 4))
plot.new()
```
...
### Plot motif signature as a radial tree.
```{r motifCloud, warning=FALSE, fig.width=3.5, fig.height=3.5, dpi=72, fig.cap=fn("Motif signature plotted as a radial tree", "F")}
## get signature
gpDist <- c(.5, 1)
...
```{r fig.cap=fn("Motif signature plotted as a radial tree", "F"), fig.width=0.1, fig.height=0.02, echo=FALSE}
par(mar=rep(0, 4))
plot.new()
```
...
###Plot motif signature as a word cloud.
```{r motifCloudRect, warning=FALSE, fig.width=3.5, fig.height=3.5, fig.cap=fn("Motif signature plotted as a word cloud with motif size representing the number of motifs contributed to the signature. The larger the size, the larger the number of motifs that share the motif signature", "G")}
...
```{r fig.cap=fn("Motif signature plotted as a word cloud with motif size representing the number of motifs contributed to the signature. The larger the size, the larger the number of motifs that share the motif signature", "G"), fig.width=0.1, fig.height=0.02, echo=FALSE}
par(mar=rep(0, 4))
plot.new()
```
...
```{r MotIV, fig.width=4, fig.height=4, fig.cap=fn("Alignment of mouse PBM data by MotIV with different CCM and alignment methods", "N")}
